...
const Header = () => {
  return (
    <header className="py-3 px-3 shadow-green-500 rounded-[7px] top-8 mx-auto flex justify-center absolute">
        <div className="flex justify-between items-center gap-3 md:gap-6 lg:gap-7 w-74 md:w-100 lg:w-120 rounded-[7px] px-5 border border-green-200 shadow-green-200 py-3 shadow-2xs">

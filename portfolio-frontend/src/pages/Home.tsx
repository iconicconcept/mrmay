...
const Home = ({ text }: Text) => {
  ...
  return (
    <div>
      <section
        className="w-full h-max md:h-[100vh] lg:h-[100vh] bg-green-50 "
        id="Home"
      >
          ...
          <div className="grid mt-20 items-center gap-12 md:gap-0 lg:gap-0 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 h-full">
            ...
            <div className="flex flex-col items-center md:items-start lg:items-start gap-7 text-center md:text-start lg:text-start">
              ...
              <p>
                ...
                hands-on experience building high quality, robust and scalable
                digital solutions. I specialized in{" "}
                <span className="font-medium">Frontend development</span>,
                turning complex UI's into functional web application that has
                real-world impact. */}
                {displayedText}
              </p>
              <div className="flex w-max flex-row justify-center md:justify-start lg:justify-start gap-3">
                <button className="px-4 text-white py-2 rounded-[7px] font-semibold bg-green-800 hover:bg-green-600">
                  <a
                ...
                <button className="px-4 text-white py-2 rounded-[7px] font-semibold cursor-pointer bg-green-500 hover:bg-green-400">
            ...
            <div className="flex justify-center items-center md:ml-12 lg:ml-12">
                  <div className="h-74 w-64 border-2 border-green-500 rounded-2xl flex justify-center items-center">
                      <div className="bg-green-200 h-70 w-60 rounded-2xl ">
                          <img src="/mubaraq1.png" className="h-full w-full rounded-2xl" alt="Profile" />
                      </div>
                  </div>
              </div>
      ...
      <section className="w-full h-max bg-green-100" id="About">
        <div className="px-5 flex flex-col gap-10 py-10 md:px-20 lg:px-20 md:py-10 lg:py-10">
          <div className="flex flex-col gap-2 justify-center items-center text-center py-3">
            <h1 className="text-2xl font-bold text-emerald-950 underline underline-offset-6">
              About Me
            </h1>
            <p className="text-[17px] font-normal text-emerald-950 md:max-w-4xl lg:max-w-4xl">
          ...
          <div className="gap-3 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3">
            <div
              className="px-5 py-6 flex flex-col gap-3 rounded-r rounded-b-lg shadow-2xl border border-green-300"
              data-aos="fade-up"
            >
        ...
        <div className="px-5 flex flex-col gap-7 py-10 md:px-20 lg:px-20 md:py-10 lg:py-10">
          ...
          <div className="gap-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {projectCardDetails.map((item) => (
              <div key={item.id}>
                <div
                  className="border h-max md:h-93 lg:h-93 px-5 py-6 flex flex-col justify-between rounded-r rounded-b-lg bg-white"
                  data-aos="fade-up"
                >
                  ...
                  <div className="flex flex-col gap-2 mt-2">
                    ...
                    <div className="flex gap-2 text-center justify-start mt-1">
                      <p className="px-2 py-0.5 bg-green-300 text-emerald-950 text-[12px] font-medium rounded-sm">
                        {item.stack}
                      </p>
                      <p className="px-2 py-0.5 bg-green-300 text-emerald-950 text-[12px] font-medium rounded-sm">
                        {item.stack2}
                    ...
                    <div className="flex gap-2 mt-3">
                      <button className="px-5 rounded-[8px] font-normal py-2 curosr-pointer bg-emerald-950 text-white">
                        <a
                          href={item.code}
                          target="_blank"
                      ...
                      <button className="px-5 rounded-[8px] font-normal border py-2 curosr-pointer bg-green-600 text-white flex items-center gap-1">
                        <a
                          href={item.live}
                          target="_blank"
      ...
      {/* fourth section */}
      <section
        className="w-full py-7 md:py-10 lg:py-10 px-5 md:px-20 lg:px-20 h-max bg-green-100"
        id="Skills"
      >
        <div className="px-5 flex flex-col gap-7 py-10 md:px-20 lg:px-20 md:py-10 lg:py-10 bg-emerald-950 rounded-2xl">
          ...
          <div className="gap-3 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3">
            <div
              className="px-5 py-5 flex flex-col gap-3 rounded-r rounded-b-lg shadow-sm shadow-emerald-900"
              data-aos="fade-up"
            >
      ...
      <section className="w-full h-max bg-green-50" id="Contact">
        <div className="px-5 flex flex-col gap-7 py-10 md:px-20 lg:px-20 md:py-10 lg:py-10">
          <div className="flex flex-col gap-2 justify-center items-center text-center py-3 text-emerald-950">
            ...
            <p className="text-[16px] font-normal md:max-w-4xl lg:max-w-4xl leading-5">
              Over the past year, I've developed expertise in these tools and
              technology
            </p>
          </div>
          <div className="flex flex-col gap-4 items-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className=" flex gap-4">
                <a
                  ...
                  target="_blank"
                  className="bg-green-100 p-2 rounded-full hover:bg-green-400"
                >
                  {" "}
                  <Twitter />{" "}
                </a>
            ...
            <div className="flex max-w-4xl w-full rounded-2xl bg-green-100 shadow-2xs">
              <form className="flex flex-col gap-4 p-6 md:p-8 lg:p-8 rounded-xl bg-white shadow-lg w-full border border-green-200">
                <h1 className="font-semibold text-emerald-900 text-[17px] mb-1">
                  Send me a Message
                </h1>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <textarea
                    ...
                    className="px-4 py-2 border border-green-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none resize-none"
                  ></textarea>
                </div>
                <button
                  type="button"
                  onClick={handleSendEmail}
                  className="px-6 py-3 items-center cursor-pointer bg-green-800 text-white flex gap-3 font-semibold rounded-md hover:bg-green-700 transition-colors w-full md:w-max"
                >
      ...
      <footer className="w-full h-max bg-green-100" id="Footer">
        <div className="px-5 flex flex-col items-center gap-1 py-7 md:px-20 lg:px-20">
          <h1 className="font-semibold font-mono text-2xl tracking-tight">
            MrMay
          </h1>
